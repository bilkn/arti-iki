      ...
      <main>
        ...
        <Content>
          <Content.ImgContainer>
            <Content.Img
              src={Img_4_JPG}
              style={{ objectPosition: '77% 77%' }}
            />
          </Content.ImgContainer>
          <Content.Wrapper>
            <Content.Heading>Hakkımızda</Content.Heading>
            <Content.Text>
              X, sektöründe marka olan X, Araba yedek parça üretim ve
              pazarlamada uluslararası üst düzey bir şirket olan X, İnşaat ve
              Turizm alanında faaliyet gösteren X ile güç birliği yapılarak
              ortaya çıkan bir dış ticaret şirketidir.
            </Content.Text>
            <br />
            <Content.Text>
            ...
            <Content.Text>
              ...
              sağlık ürünleri, Makine, Yedek Parça, Metal ve Kauçuk döküm
              ürünleri göndermektedir.
            </Content.Text>
          </Content.Wrapper>
        </Content>
        {/* ABOUT SECTION END */}
        ...
        <Content style={{ background: 'black', color: '#fff' }}>
          ...
          <Content.Wrapper>
            ...
            <Content.Text>
              Sıfır hata, %100 müşteri memnuniyeti ile Türkiye ve dünya
              pazarında lider kuruluşlar arasında olmayı hedefleyen X,
            </Content.Text>
            <br />
            <Content.Text>
              Alanında öncü bir geleceğe oynarken iş ortakları ile yaratıcı
              çözümler üreten, teknoloji ve markaları ile fark yaratan, bireye
              ve çevreye saygılı bir dünya şirketi olmayı da amaçlıyor.
            </Content.Text>
            <br />
        ...
        <Content className="last-content-style">
          <Content.ImgContainer>
            <Content.Img
              src={Img_3_JPG}
          ...
          <Content.Wrapper>
            ...
            <Content.Text>
              ...
              memnuniyet oranını arttırmak ve güvenilir ve aranan bir firma
              olmak.
            </Content.Text>
            <br />
            <Content.Text>
            ...
            <br />
            <Content.Text>
              • Çalışanlarımız arasında karşılıklı güven, saygı, sevgi, anlayış
              ve iletişimi hep daha iyiye götürmek.
            </Content.Text>
            <br />
            <Content.Text>
              • İş hacmini sürekli geliştirmek ve ülke ekonomisine sürekli
              katkıda bulunmak.
            </Content.Text>
            <br />
            <Content.Text>
            ...
            <br />
            <Content.Text>
              • Açık, şeffaf ve etik kuralları önemseyen, yasal mevzuata uyan
              bir firma olmak.
            </Content.Text>
            <br />
            <Content.Text>
